...
public class QrCodeUtil {
    ...
    public static String encodeAndBase64Str(String content, String imgPath, boolean needCompress) throws Exception {
        ...
        //转换成base64串
        return CommonConstant.IMG_BASE64_PREFIX + Base64Utils.encodeToString(baos.toByteArray()).trim();
    }
    ...
    public static void encode(String content, String imgPath, String destPath,
        ...
        ImageIO.write(image, FORMAT_NAME, baos);
        //转换成base64串
        String jpgBase64 = Base64Utils.encodeToString(baos.toByteArray()).trim();
